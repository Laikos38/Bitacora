...
## Dope libraries and modules
- [jazzband modules - insane django apps](https://jazzband.co/projects)
- [More django apps](https://blog.devgenius.io/2021-top-100-django-packages-list-during-the-year-92fef0ba79c9)
- [requests-HTML - scraping tool](https://docs.python-requests.org/projects/requests-html/en/latest/?utm_source=pocket_saves)
- [httpx - async request library](https://www.python-httpx.org/)
- [supertokens - auth open source](https://github.com/supertokens/supertokens-core)
...
- [fetoolkit - tools](https://www.fetoolkit.io/)
- [Mermaid - text graphic tool](https://mermaid-js.github.io/mermaid/)
